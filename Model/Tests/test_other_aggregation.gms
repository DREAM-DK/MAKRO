...
parameter vHhNet_test[t]; vHhNet_test[t]$(tx1[t] and t.val >= 1996) = 
  ...
  vHhNet.l[t-1]/fv 
   + vHhNetRenter.l[t] + vHhOmv.l['tot',t]
    ...
    + vHhNFErest.l[aTot,t]
    - vtHh.l[aTot,t]
    - (vC.l[cTot,t] - vLejeAfEjerBolig.l[t]) # = -(pC['Cx',t] * qCx[aTot,t] + vCLejeBolig[aTot,t] + rBoligOmkRest[t] * vBolig[aTot,t-1]/fv)
    - vIBolig.l[t] # Boliginvesteringer
    );
abort$(smax(t, abs(vHhNet_test[t])) > 0.03) "vHhNet does not match DST-equation", vHhNet_test;
