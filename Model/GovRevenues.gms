...
$IF %stage% == "variables":
  ...
  $GROUP G_GovRevenues_endo
    ...
    vtSelskabRest[s_,t]$(sTot[s_]) "J-led til at ramme branchefordelt selskabsskat - inkluderer tillægsskat for kulbrinteselskaber (kun relevant for udv)"
...
# ----------------------------------------------------------------------------------------------------------------------
    ...
    E_vtSelskab[sp,t].. vtSelskab[sp,t] =E= tSelskab[t] * ftSelskab[t] * vEBT[sp,t] + vtSelskabRest[sp,t];
    E_vtSelskab_sTot[t].. vtSelskab[sTot,t] =E= sum(sp, vtSelskab[sp,t]);
    E_vtSelskab_sTot_via_vSelskabRest[t].. vtSelskab[sTot,t] =E= tSelskab[t] * ftSelskab[t] * vEBT[sTot,t] + vtSelskabRest[sTot,t];
